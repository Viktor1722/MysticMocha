    ...
    <main className="demoPage2">
      <div className="container">
        ...
        <div className="flip-card-box">
          <div
            className="flip-card_demo2"
            onClick={() => setIsFlipped(!isFlipped)}
          >
            <div
              className={`flip-card-inner_demo2 ${isFlipped ? "flipped" : ""}`}
            >
              <div className="flip-card-front_demo2">
                <img className="touch-icon" src={touchIcon} alt=""></img>
              </div>
              <div className="flip-card-back_demo2">
