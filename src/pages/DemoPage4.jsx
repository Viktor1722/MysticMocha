    ...
    <main className="demoPage4">
      <div className="container">
        ...
        <div className="flip-card-box">
          <div
            className="flip-card_demo4"
            onClick={() => setIsFlipped(!isFlipped)}
          >
            <div
              className={`flip-card-inner_demo4 ${isFlipped ? "flipped" : ""}`}
            >
              <div className="flip-card-front_demo4">
                <img className="touch-icon" src={touchIcon} alt=""></img>
              </div>
              <div className="flip-card-back_demo4">
