    ...
    <main className="demoPage5">
      <div className="container">
        ...
        <div className="flip-card-box">
          <div
            className="flip-card_demo5"
            onClick={() => setIsFlipped(!isFlipped)}
          >
            <div
              className={`flip-card-inner_demo5 ${isFlipped ? "flipped" : ""}`}
            >
              <div className="flip-card-front_demo5">
                <img className="touch-icon" src={touchIcon} alt=""></img>
              </div>
              <div className="flip-card-back_demo5">
