    ...
    <main className="demoPage3">
      <div className="container">
        ...
        <div className="flip-card-box">
          <div
            className="flip-card_demo3"
            onClick={() => setIsFlipped(!isFlipped)}
          >
            <div
              className={`flip-card-inner_demo3 ${isFlipped ? "flipped" : ""}`}
            >
              <div className="flip-card-front_demo3">
                <img className="touch-icon" src={touchIcon} alt=""></img>
              </div>
              <div className="flip-card-back_demo3">
